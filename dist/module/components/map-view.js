...
function _MapView(props, ref) {
  ...
  useImperativeHandle(ref, () => ({
    ...
    setCamera(camera) {
      map === null || map === void 0 || map.moveCamera(transformRNCameraObject(camera));
    },
  ...
  const mapNode = useMemo(() => {
    ...
    return /*#__PURE__*/React.createElement(GoogleMap, {
      ...
      onDrag: () => {
        ...
        const center = map === null || map === void 0 ? void 0 : map.getCenter();
        (_props$onPanDrag = props.onPanDrag) === null || _props$onPanDrag === void 0 || _props$onPanDrag.call(props, mapMouseEventToMapEvent(null, center && {
          latitude: center.lat(),
          longitude: center.lng()
        }, map, undefined));
      },
