...
function _MapView(props, ref) {
  ...
  const _onMapReady = (0, _react.useCallback)(_map => {
    ...
    setMap(_map);
    (_props$onMapReady = props.onMapReady) === null || _props$onMapReady === void 0 || _props$onMapReady.call(props);
  ...
  const _onRegionChange = (0, _react.useCallback)(() => {
    ...
    if (bounds) {
      ...
      (_props$onRegionChange = props.onRegionChange) === null || _props$onRegionChange === void 0 || _props$onRegionChange.call(props, {
        latitude: center.lat(),
  ...
  const _onRegionChangeComplete = (0, _react.useCallback)(() => {
    ...
    if (bounds) {
      ...
      const latitudeDelta = Math.abs(northEast.lat() - southWest.lat());
      const center = bounds.getCenter();
      (_props$onRegionChange2 = props.onRegionChangeComplete) === null || _props$onRegionChange2 === void 0 || _props$onRegionChange2.call(props, {
        latitude: center.lat(),
        longitude: center.lng(),
        latitudeDelta,
        longitudeDelta
  ...
  (0, _react.useImperativeHandle)(ref, () => ({
    ...
    setCamera(camera) {
      map === null || map === void 0 || map.moveCamera((0, _camera.transformRNCameraObject)(camera));
    },
    ...
    fitToCoordinates(coordinates, options) {
      const bounds = new google.maps.LatLngBounds();
      if (coordinates) {
        coordinates === null || coordinates === void 0 || coordinates.forEach(c => bounds.extend({
          lat: c.latitude,
          lng: c.longitude
        }));
      }
      map === null || map === void 0 || map.fitBounds(bounds, options === null || options === void 0 ? void 0 : options.edgePadding);
    },
  ...
  const mapNode = (0, _react.useMemo)(() => {
    ...
    return /*#__PURE__*/_react.default.createElement(_api.GoogleMap, {
      ...
      onDrag: () => {
        ...
        const center = map === null || map === void 0 ? void 0 : map.getCenter();
        (_props$onPanDrag = props.onPanDrag) === null || _props$onPanDrag === void 0 || _props$onPanDrag.call(props, (0, _mouseEvent.mapMouseEventToMapEvent)(null, center && {
          latitude: center.lat(),
          longitude: center.lng()
        }, map, undefined));
      },
...
//# sourceMappingURL=map-view.js.map.memo)( /*#__PURE__*/(0, _react.forwardRef)(_MapView));
